...
*NOTE (Added 12/4/2018): For more information about methodology and answers to some common questions about using CDC data for this analysis, please read the [FAQS document](https://github.com/GateHouseMedia/PLBID/blob/master/FAQS.md).*
